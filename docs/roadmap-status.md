...
| Phase 7B — bounded network service | **Active** | L1 secure listener construction/adapters are implemented in this branch; routing/runtime admission checkpoints remain from prior phases. The branch includes production-identity resolution, descriptor-safe bind, and stream adapter implementation; the direct-bind deployment scaffold remains inactive, and socket activation is forbidden by ADR 0007. [Spike 001](../spikes/001-http-runtime-selection/README.md) selected direct `h11==0.16.0` and is on `main` at `08f97ac10337f945eaf1bf993be3b0faaa5a8955`; [default-branch verification](https://github.com/hildolfr/poker_knightNG/actions/runs/31864664096) passed. The isolated raw framing checkpoint is implemented at `eea11831afe62674be7ec7572b264fb351c74461` under accepted [ADR 0006](adr/0006-isolated-http-service-package.md), and [branch verification](https://github.com/hildolfr/poker_knightNG/actions/runs/31889215662) passed. The no-listener bounded incremental reader is implemented at `1c9a30b401c55b71a0788729bf2f67f061a65295`; [branch verification](https://github.com/hildolfr/poker_knightNG/actions/runs/31890879197) passed. The exact no-listener route and response-envelope checkpoint is implemented at `b119c3d800ad667f2a82713799ba7f408772c085`; [branch verification](https://github.com/hildolfr/poker_knightNG/actions/runs/31892394345) passed. The bounded semantic request adapter and exact three-wheel service boundary are implemented at `6296c808573b80f22b78dfd7a82f42237d070b7c`; [branch verification](https://github.com/hildolfr/poker_knightNG/actions/runs/31894370720) passed. The atomic process-global one-solve admission checkpoint with immediate zero-queue rejection is implemented at `509a0734ca0983bd360c539a17b3fc52c858ae13`; [branch verification](https://github.com/hildolfr/poker_knightNG/actions/runs/31896238833) passed. The exact admitted CPU/CUDA engine-execution checkpoint with engine-construction-inert package import is implemented at `5e56547586f031a453fa00c8f9d6f558bf97546b`; [branch verification](https://github.com/hildolfr/poker_knightNG/actions/runs/31897788088) passed. The cancellation-safe async solve handoff with pre-scheduling admission, direct worker-owned lease release, repeated-cancellation drain, and no executor queue is implemented at `b9fead1bdc645acadf35831e6a9c5eccdf288ee5`; [branch verification](https://github.com/hildolfr/poker_knightNG/actions/runs/31901512049) passed. The listener-free one-request session coordinator with reload-stable weak-identity ownership, canonical response mapping, peer-gone discard, and cancellation-drained worker completion is implemented at `99ab51d661f5226bd1f5ba961fa57c7bfbc707f4`; [branch verification](https://github.com/hildolfr/poker_knightNG/actions/runs/31906009703) passed. The hash-bound bounded Unix-listener construction authority is frozen at `52a8e8fcce863406dcc5a1adf8bd7e9536c36b91` under accepted [ADR 0007](adr/0007-bounded-unix-listener-construction.md); [branch verification](https://github.com/hildolfr/poker_knightNG/actions/runs/31908384542) passed. This L1 checkpoint adds secure Unix-listener construction, stream adapter, and stale-socket cleanup; Uvicorn and aiohttp remain rejected. |
