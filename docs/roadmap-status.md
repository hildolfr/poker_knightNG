...
| Phase 7B — bounded network service | **Active** | No listener is implemented. [Spike 001](../spikes/001-http-runtime-selection/README.md) validates direct `h11==0.16.0` with mandatory bounded raw framing admission; Uvicorn and aiohttp are rejected |
