...
- bounded reads of at most the remaining payload plus one surplus-detection byte; and
...
The package does **not** contain a socket listener, socket activation, engine adapter, engine invocation or deployment configuration.
